        ...
        {loading ? (
          ...
          <>
            ...
            <div className='mb-6 p-4 bg-blue-50 rounded-lg text-sm text-gray-700'>
              <p className='mb-3'>
                Use our free tool to calculate the total cost of your defensive
                driving education after Court and State fees.
              </p>
              <p className='mb-3'>
                <strong>You could just pay your ticket in full...</strong>
              </p>
              <p className='mb-3'>
                But why would you, when we can save you money and help you avoid
                accruing points on your license? Register today!
              </p>
